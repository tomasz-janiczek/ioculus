/************************************************************************************************************
	...
	*/	
	...
	function mouseoverTopbar()
	{
		...
		var src = img.alt;
		img.alt = img.alt.replace('.gif','_over.gif');
	...
	function mouseoutTopbar()
	{
		var img = this.getElementsByTagName('IMG')[0];
		var src = img.alt;
		img.alt = img.alt.replace('_over.gif','.gif');		
	...
	function initDhtmlgoodies_xpPane(panelTitles,panelDisplayed,cookieArray)
	{
		...
		for(var no=0;no<divs.length;no++){
			if(divs[no].className=='dhtmlgoodies_panel'){
				...
				img.src = '/images/arrow_green.jpg';
				img.alt = 'images/arrow_up.gif';
				img.style.visibility = "hidden";
				topBar.appendChild(img);

				var dotImg = document.createElement('IMG');
				topBar.innerHTML = '<img class="dhtmlgoodies_xpPane_dotimg" src="/www/images/arrow_green_double.jpg"/>' + topBar.innerHTML;
